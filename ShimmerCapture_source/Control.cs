    ...
    public partial class Control : Form
    {
        ...
        public void buttonStop_Click1()
        {
            ...
            if (EnableHPF_0_05HZ || EnableHPF_0_5HZ || EnableHPF_5HZ)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting HPF_Exg1 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            if (EnableNQF)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting NQF_Exg1 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            if (EnableNQF)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting NQF_Exg2 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            if (EnableHPF_0_05HZ || EnableHPF_0_5HZ || EnableHPF_5HZ)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting HPF_Exg2 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            if (EnableBSF_49_51HZ || EnableBSF_59_61HZ)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting BSF_Exg1 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            if (EnableBSF_49_51HZ || EnableBSF_59_61HZ)
            {
                ...
                {
                    ErrorLogger.LogWarning("Error resetting BSF_Exg2 buffers", ex, "Control.buttonStop_Click1");
                }
            }
            // clear all signal selections
            SelectedSignalNameGroup1.Clear();
